...
public class DepartmentController {
    ...
    public ResponseEntity<List<DepartmentProjection>> getAllDepartmentProjections() {
        List<DepartmentProjection> projections = departmentService.getAllDepartmentProjections();
        return new ResponseEntity<>(projections, HttpStatus.OK);
    }

    // Get all department views
    @GetMapping("/views")
    public ResponseEntity<List<DepartmentView>> getAllDepartmentViews() {
        List<DepartmentView> views = departmentService.getAllDepartmentViews();
